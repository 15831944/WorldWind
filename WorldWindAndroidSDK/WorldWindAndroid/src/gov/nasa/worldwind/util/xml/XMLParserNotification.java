...
/**
 * @author tag
 * @version $Id: XMLParserNotification.java 771 2012-09-14 19:30:10Z tgaskins $
 */
public class XMLParserNotification extends PropertyChangeEvent
{
    ...
    public String toString()
    {
        ...
        if (this.event != null)
        {
            msg = Logging.getMessage(this.message, this.event.toString(), this.event.getLineNumber());
        }
        else
        {
