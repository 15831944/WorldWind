 ...
 */
/**
 * @exports UserFacingTextProgram
 * @version $Id: UserFacingTextProgram.js 2658 2015-01-19 23:51:58Z danm $
 */
define([
        '../error/ArgumentError',
        '../util/Color',
     ...
     */
    var UserFacingTextProgram = function(gl) {
    ...
    UserFacingTextProgram.prototype = Object.create(GpuProgram.prototype);
     ...
     */
    UserFacingTextProgram.prototype.loadModelviewProjection = function (gl, matrix) {
        if (!matrix) {
            throw new ArgumentError(
                Logger.logMessage(Logger.LEVEL_SEVERE, "UserFacingTextProgram", "loadModelviewProjection",
                    "missingMatrix"));
        }
     ...
     * @throws {ArgumentError} If the specified matrix is null or undefined.
     */
    UserFacingTextProgram.prototype.loadTexSamplerMatrix = function (gl, matrix) {
        if (!matrix) {
            throw new ArgumentError(
                Logger.logMessage(Logger.LEVEL_SEVERE, "UserFacingTextProgram", "loadTexSamplerMatrix",
                    "missingMatrix"));
        }
     ...
     */
    UserFacingTextProgram.prototype.loadTexSampler = function (gl, unit) {
        gl.uniform1i(this.texSamplerLocation, unit - WebGLRenderingContext.TEXTURE0);
    };

    return UserFacingTextProgram;
});