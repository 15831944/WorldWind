...
The source files are set up for documentation generation by AppleDoc (http://gentlebytes.com/appledoc/). Use the script
MakeAPIDocs.sh to generate the documentation.
...
- Running the Appledoc doc generation script on some systems causes the following message, yet the documentation is
correctly generated:
