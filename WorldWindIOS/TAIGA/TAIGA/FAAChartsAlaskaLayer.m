/*
 ...
 @version $Id: FAAChartsAlaskaLayer.m 1655 2013-10-04 17:38:55Z tgaskins $
 */
...
- (void) makeLayerForName:(NSString*)layerName displayName:(NSString*)displayName sector:(WWSector*)sector
{
    ...
    [layer setEnabled:[Settings                                 getBoolForName:
            [[NSString alloc] initWithFormat:@"gov.nasa.worldwind.taiga.layer.renderable.enabled.%@",
                                             [layer displayName]] defaultValue:NO]];
